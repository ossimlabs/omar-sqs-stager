...
import omar.sqs.stager.app.SqsStagerService
...
class SqsStagerServiceSpec extends Specification implements ServiceUnitTest<SqsStagerService> {
    ...
    def 'Testing downloadFile method with JSON Object'() {
        given:
        def builder = new groovy.json.JsonBuilder()
        def jsonObj = builder.Message {
            "Message" {
                "abstract" "SICD                            ,                                          blah"
                "actualBitCountPerPixel" 0
                "areaTargetId" ""
                "bENumber" ""
                "bandCountQuantity" 0
                "boundingPolygonTypeCode" ""
                "centroidCoordinates" ""
                "circularError" ""
                ...
                "footprintGeometry" ""
                "grazingAngle" ""
                "iCEDHAuthorizationReference" ""
                "iCEDHClassification" ""
                "iCEDHClassificationReason" ""
                "iCEDHClassifiedBy" ""
                "iCEDHDESVersion" ""
                "iCEDHDataItemCreateDateTime" ""
                "iCEDHDeclassExceptions" ""
                "iCEDHDerivedFrom" ""
                "iCEDHDisseminationControls" ""
                "iCEDHIdentifier" ""
                "iCEDHLAC" ""
                "iCEDHMAF" ""
                "iCEDHOwnerProducer" ""
                "iCEDHReleasableTo" ""
                "iCEDHResponsibleEntityCountry" ""
                "iCEDHResponsibleEntityOrganization" ""
                "iCEDHResponsibleEntitySuborganization" ""
                "iCEDHSciControls" ""
                "iGEOLO" ""
                "imageCenterPoint2D" ""
                "imageId" "SICD  16MAY02111607-P1BS-055998375010_01_P014"
                "imagePolarization" ""
                "imageQualityRatingScale" 0
                "imageRepresentation" ""
                "imageRollAngle" 0
                "imageTypeCode" ""
                "jpegReducedResolution" ""
                "keyword" ""
                "keyword10" ""
                "keyword2" ""
                "keyword3" ""
                ...
                "mBRSOUTH" 0
                "mBRWEST" 0
                "meanGroundSpacingDistance" 0
                "missionID" ""
                "oMARURI" ""
                "obliquityAngle" 0
                "observationDateTime" "2016-05-02T00 00 00.000Z"
                "originationStationId" ""
                "platformName" ""
                "processingLevel" ""
                "producerClass" ""
                "producerCode" ""
                "productCreationDate" ""
                "rapidPositioningCapabilityIndicator" true
                "referenceImageTypeText" ""
                "replayDesignator" ""
        ...
        expect: 'foobar'
        //service.downloadFile(jsonObj).status == HttpStatus.METHOD_NOT_ALLOWED
    ...
    @Ignore
    def 'checkDownloadBlackList method with full imageId of "SICD 123456789" == true' ()
    {
        expect:
    ...
    @Ignore
    def 'checkDownloadBlackList method with full imageId of "SIDD: 14SEP15TS0107001_100021_SL0023L_25N121E_001X___SVV_0101_OBS_IMAG" == true' ()
    {
        expect:
    ...
    @Ignore
    def 'checkDownloadBlackList method with lower case imageId partial of "sicd" should == true' ()
    {
        expect:
    ...
    @Ignore
    def 'checkDownloadBlackList method with lower case imageId partial of "bar" should == true' ()
    {
        expect:
    ...
    @Ignore
    def 'checkDownloadBlackList method with mixed case imageId partial of "SicD" should == true' ()
    {
        expect:
            service.checkDownloadBlackList('SicD') == true
    }
    ...
    @Ignore
    def 'checkDownloadBlackList method with non-matching imageId partial of "sick" should == false' ()
    {
        expect:
    ...
    @Ignore
    def 'checkDownloadBlackList method with non-matching/mixed case imageId partial of "sICk" should == false' ()
    {
        expect:
        service.checkDownloadBlackList('sick') == false
    }
    ...
    @Ignore
    def 'checkDownloadBlackList method with non-matching imageId partial and random characters with whitespace should == true' ()
    {
        expect:
        service.checkDownloadBlackList('sicd ,%') == true
    }
    ...
    @Ignore
    def 'checkDownloadBlackList method with mixed case imageId partial of "16mAy" should == true' () {
        expect:
    ...
    @Ignore
    def 'checkDownloadBlackList method with passing a null imageId should == false' () {
        expect:
    ...
    @Ignore
    def 'Testing downloadFile method with imageId: 16MAY02111607-P1BS-055998375010_01_P014 that should return message (Black listed)' () {
        setup:
    ...
    //@Ignore
    def 'Testing downloadFile method with imageId: 16MAY02111607-P1BS-055998375010_01_P014 that should return METHOD_NOT_ALLOWED ' () {
        setup:
